/*
  ...
  - You are about to drop the column `idPaintings` on the `Rate` table. All the data in the column will be lost.
  - Added the required column `idPainting` to the `Rate` table without a default value. This is not possible if the table is not empty.
